@props(['title' => __('Confirmar Senha'), 'content' => __('Para sua segurança, confirme sua senha para continuar.'), 'button' => __('Confirmar')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="block w-3/4 mt-1" placeholder="{{ __('Senha') }}"
