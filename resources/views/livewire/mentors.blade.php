<div class="p-6 sm:px-10 bg-white border-b border-gray-200">
                                ...
                                @forelse ($mentors as $mentor)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button wire:click="confirmMentorEditing({{ $mentor->id }})" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                                    <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                                </svg>
                                            </button>
                                            <button wire:click="confirmMentorDeletion({{ $mentor->id }})" wire:loading.attr='disabled' class="text-red-600 hover:text-red-900">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <x-jet-confirmation-modal wire:model="confirmingMentorDeletion">
        ...
        <x-slot name="content">
            {{ __('Tem certeza de que deseja excluir este mentor?') }}
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ml-3" wire:click="deleteMentor({{ $confirmingMentorDeletion }})" wire:loading.attr="disabled">
                {{ __('Deletar') }}
            </x-jet-danger-button>
        </x-slot>
    ...
    <x-jet-dialog-modal wire:model="confirmingMentorAddition" maxWidth="lg">
        <x-slot name="title">
            {{ ($this->actionAdd) ? __('Adicionar mentor') : __('Editar mentor') }}
        </x-slot>
                ...
                <div class="md:col-span-2">
                    <div class="grid grid-cols-6 gap-3">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <x-jet-input id="name" type="text" class="mt-1 block w-full" wire:model.defer="state.name" placeholder="Digite o nome"/>
