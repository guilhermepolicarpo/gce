    ...
    <div class="flex justify-between items-end">        
        ...
        <div class="mr-2 w-1/4">
            <div class="mt-1 relative rounded-md shadow-sm">
                ...
                <label for="search" class="text-gray-500 sm:text-sm">Pesquisar</label>
                <input wire:model.debounce.500ms='q' class="border-1 border-gray-300 bg-white h-10 w-full px-5 pl-9 rounded-lg text-sm focus:outline-none focus:border-indigo-500/75" type="search" name="search" placeholder="Pesquisar">
            </div>
        </div>
        <!-- Add Patient -->
        <div class="mr-2">
