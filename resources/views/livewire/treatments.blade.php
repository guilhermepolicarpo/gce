                ...
                <div class="md:col-span-2">
                    <div class="grid grid-cols-6 gap-3">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            {{-- <select name="modo" id="modo" wire:model.defer="state.treatment_type_id" wire:keydown.enter="saveTreatment()" class="border-1 border-gray-300 bg-white w-full rounded-lg text-sm focus:outline-none focus:border-indigo-500/75">
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            {{-- <select name="modo" id="modo" wire:model.defer="state.treatment_mode" wire:keydown.enter="saveTreatment()" class="border-1 border-gray-300 bg-white w-full rounded-lg text-sm focus:outline-none focus:border-indigo-500/75">
                                <option value="">Selecione</option>
                        ...
                        <div class="col-span-6 sm:col-span-6 bg-gray-50 p-5 rounded-lg">
                            ...
                            {{-- <x-jet-input id="date" type="date" wire:model.defer="state.date" wire:keydown.enter="saveTreatment()" class="mt-1 block w-full text-gray-500 sm:text-sm border-gray-300 focus:outline-none focus:border-indigo-500/7" />
