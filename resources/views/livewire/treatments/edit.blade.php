<div class="p-6 bg-white border-b border-gray-200 sm:p-10 sm:rounded-lg">
    <div class="px-4 py-5 rounded shadow bg-gray-50 sm:p-6 md:grid md:grid-cols-2 md:gap-6">
        <div class="md:col-span-1">
            ...
            <p>{{ "Idade: ".$treatment->patient->age }} </p>
            @endisset
        ...
        <div class=" md:col-span-1 md:mt-7 sm:mt-0">
            @isset($treatment->treatmentType->name)
            <p>{{ 'Atendimento: '.$treatment->treatmentType->name }}</p>
            @endisset
                    ...
                    <div class="px-4 py-5 bg-gray-50 sm:p-6">
                        <div class="flex flex-row gap-1">
                            ...
                            <x-datetime-picker display-format="DD/MM/YYYY" without-timezone without-time label="Retirada"
                                placeholder="Data" wire:model.defer="treatmentState.infiltracao_remove_date" time-format="24" />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="flex justify-end">
    ...
    <x-jet-button class="ml-3" wire:click="updateTreatment()" wire:loading.attr="disabled">
        {{ __('Atualizar') }}
    </x-jet-button>
</div>
</div>
