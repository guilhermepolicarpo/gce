                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                            <button wire:click="confirmUserEditing({{ $user->id }})" class="mr-3 text-indigo-600 hover:text-indigo-900">
                ...
                <div class="md:col-span-2">
                    <div class="grid grid-cols-6 gap-3">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <x-jet-input id="name" type="text" class="block w-full mt-1" wire:model.defer="name" placeholder="Digite o nome"/>
                            <x-jet-input-error for="name" class="mt-2" />
                        </div>

                        <div class="col-span-6 sm:col-span-6">
                            <x-jet-label for="email" value="{{ __('E-mail') }}" />
                            <x-jet-input id="email" type="email" class="block w-full mt-1" wire:model.defer="email" placeholder="Digite o e-mail"/>
                            <x-jet-input-error for="email" class="mt-2" />
                        </div>

                        <div class="col-span-6 sm:col-span-6">
                            <x-jet-label for="password" value="{{ __('Senha') }}" />
                            <x-jet-input id="password" class="block w-full mt-1" type="password" wire:model.defer="password" name="password" required autocomplete="new-password" placeholder="***"/>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <x-jet-input id="password_confirmation" class="block w-full mt-1" type="password" wire:model.defer="password_confirmation" name="password_confirmation" required autocomplete="new-password" placeholder="***" />
                            <x-jet-input-error for="password" class="mt-2" />
                            @if ($this->actionAdd == false)
                                <span class="text-xs text-gray-500">Deixe em branco para manter a senha atual</span>
                            @endif
